...
@section('content')
<br>
    <h4 class="m-0">Detalle de la compra</h4>
    <br>
    <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" value="{{$compra->proveedor->empresa}}" name="empresa" class="form-control" id="empresa" disabled>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form group" style="text-align: center">
                                            ...
                                            <input type="text" class="form-control" name="precio_total"  value="{{$total_compra}}" style="background-color:#ffea1c; font-weight: bold;  text-align: center;" disabled> </b>
                                            @error('precio_total')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="font-size: 15px;">
                                        <div class="form group" class="col-md-12">
                                            <a href="{{'/admin/compras'}}" class="btn btn-danger" style="display: block; margin: 0 auto;">Volver</a>
