...
@section('content')
<br>
    <h4 class="m-0">Actualizacion de la Compra: {{$compra->fecha_compra}}</h4>
    <br>
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form group">
                                            ...
                                            <input type="text" class="form-control" name="comprobante_compra"  value="{{$compra->comprobante_compra}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="font-size: 15px;">
                                        <div class="form group" >
                                            <button type="submit" class="btn btn-warning"><i class="bi bi-floppy-fill" ></i> Actualizar compra</button>
