                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form group">
                                            ...
                                            <input type="text" class="form-control" name="codigo_producto" required value="{{$producto->codigo_producto}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form group">
                                            ...
                                            <input type="text" class="form-control" name="nombre_producto" required value="{{$producto->nombre_producto}}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form group">
                                            ...
                                            <textarea name="descripcion_producto" id="" cols="30" rows="2" required  class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form group">
                                            ...
                                            <input type="number" class="form-control" name="stock_producto" required value="{{$producto->stock_producto}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form group">
                                            ...
                                            <input type="number" class="form-control" name="stock_minimo_producto" required value="{{$producto->stock_minimo_producto}}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form group">
                                            ...
                                            <input type="number" class="form-control" name="stock_maximo_producto" required value="{{$producto->stock_maximo_producto}}">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form group">
                                            ...
                                            <input type="text" class="form-control" name="costo_producto" required value="{{$producto->costo_producto}}"">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form group">
                                            ...
                                            <input type="text" class="form-control" name="precio_producto" required value="{{$producto->precio_producto}}">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form group">
                                            ...
                                            <input type="date" class="form-control" name="fecha_ingreso_producto" required value="{{$producto->fecha_ingreso_producto}}">
