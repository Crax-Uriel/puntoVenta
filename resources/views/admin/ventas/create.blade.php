...
@section('content')
<br>
    <h4 class="m-0">Registro de Ventas</h4>
    <br>
    <div class="row">
        <div class="col-md-12" style="font-size: 15px;">
            <div class="card card-outline card-primary">
                ...
                {{-- form_venta --}}
                <form action="{{url('/admin/ventas/create')}}" method="POST" id="form_venta">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <table  class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody style="text-align: center">
                                            ...
                                            @foreach ($tmp_Ventas as $tmp_Venta)
                                                ...
                                                <tr>
                                                    <td>{{ $contador++}}</td>
                                                    <td>{{ $tmp_Venta ->producto->codigo_producto}}</td>
                                                    <td>{{ $tmp_Venta ->cantidad_compra}}</td>
                                                    <td>{{ $tmp_Venta ->producto->nombre_producto}}</td>
                                                    <td>{{ $tmp_Venta ->producto->precio_producto}}</td>
                                                    <td>{{ $costo =$tmp_Venta ->cantidad_compra *   $tmp_Venta ->producto->precio_producto}}</td>
                                                    <td>
                                                ...
                                                @php
                                                    $total_cantidad += $tmp_Venta->cantidad_compra;
                                                    $total_venta +=$costo ;
                                                @endphp
                                            @endforeach
                                        </tbody>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <label for="">Nombre del Cliente</label> <b>*:</b>
                                        <input type="text" class="form-control" id="ncliente" disabled value="S/N">
                                        <input type="text" name="cliente_id" class="form-control" id="id_cliente"  hidden >
                                    </div>

                                    <div class="col-md-5">
                                        <label for="">RFC</label> <b>*:</b>
                                        <input type="text" class="form-control" id="rfc_cliente" disabled value="0">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form group">
                                            ...
                                            <input type="date" class="form-control" name="fecha_venta"  value="{{old('fecha_venta',date('Y-m-d'))}}">
                                            @error('fecha_venta')
                                                <small style="color: red">{{$message}}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="font-size: 15px;">
                                        <div class="form group">
                                            <button type="submit" class="btn btn-primary"><i class="bi bi-floppy-fill"></i> Registrar Venta</button>
